    ...
    return (
        <div className="container flex h-48 mt-24 sm:justify-between justify-normal gap-5">
            <div className="flex w-7/12 flex-col">
                ...
                <p className="text-gray-400 py-5 text-xs md:text-sm">
            ...
            <div className="flex w-2/12 flex-col [&>ul>li>a]:text-green-400">
                ...
                <ul>
                    ...
                    <li className='flex'>
                        <a className="text-green-400 flex gap-2 items-center" href="https://www.linkedin.com/in/michael-apaza-calsin-a99572180/" target="_blank" rel="noopener noreferrer">
